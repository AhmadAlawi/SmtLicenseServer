...
@include('partials.seo-meta', [
    'title' => 'Tillora — A Self-Serve Alternative to V-TECH for Multi-Branch Retail',
    'description' => 'Looking for a V-TECH POS alternative? Tillora gives multi-branch retail shops transparent pricing, instant self-serve signup, and a private instance per store — no sales call required.',
])
