...
class MetaClient
{
    ...
    /** Ads-only — no pages_manage_posts/instagram_content_publish. business_management lists ad accounts under a Business Manager; pages_show_list is read-only Page visibility; pages_read_engagement is needed to read the Page's linked instagram_business_account field. */
    private const SCOPES = 'ads_management,ads_read,business_management,pages_show_list,pages_read_engagement';
